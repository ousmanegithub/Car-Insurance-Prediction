...
def load_data_and_model():
    ...
    df_pred = df_raw.drop(['Id', 'CallStart', 'CallEnd', 'CallDuration_min', 'Default', 'HHInsurance', 'CarLoan'], axis=1)
...
with st.sidebar:
    ...
    page = st.radio("Section", ["Dashboard Analytique", "Prédiction Client"])
...
<div style='text-align: center; color: #666; padding: 20px;'>
    <strong>Projet IA</strong> —  Réseaux de Neurones Profonds<br>
